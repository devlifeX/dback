...
**Current app version:** `3.8.1` — must match `main.go`, `build.sh`, and the release git tag `v3.8.1`.

## Pre-release checklist

| File | Field |
|------|-------|
| `main.go` | `appVersion = "3.8.1"` |
| `build.sh` | `APP_VERSION="${APP_VERSION:-3.8.1}"` |
| `debian/changelog` | e.g. `dback (3.8.1-1~ubuntu24.04.1) noble` |
